...
image_path1 = "./노지 작물 질병 진단 이미지/Training/[원천]파_0.정상"
image_path2 = "./노지 작물 질병 진단 이미지/Training/[원천]파_1.질병"
image_path3 = "./노지 작물 질병 진단 이미지/Training/[원천]파_9.증강"

label_path1 = "./노지 작물 질병 진단 이미지/Training/[라벨]파_0.정상"
label_path2 = "./노지 작물 질병 진단 이미지/Training/[라벨]파_1.질병"
label_path3 = "./노지 작물 질병 진단 이미지/Training/[라벨]파_9.증강"
...
model_pa_dir = 'save_model/h5'
model_pa_path = os.path.join(cur_dir, model_pa_dir)
model_pa_file = os.path.join(model_pa_path, 'pa.0526.50.h5')
os.makedirs(model_pa_path, exist_ok = True)
model.save(model_pa_file,save_format='h5')

# model.save('gochu.h5')
model.save_weights('pa_weights_1.h5')