...
image_path1 = "./노지 작물 해충 진단 이미지/Training/[T원천]02.고추_0.정상"
image_path2 = "./노지 작물 해충 진단 이미지/Training/[T원천]02.고추_2.해충"

label_path1 = "./노지 작물 해충 진단 이미지/Training/[T라벨링]02.고추_0.정상"
label_path2 = "./노지 작물 해충 진단 이미지/Training/[T라벨링]02.고추_2.해충"
...
for file in os.listdir(label_path1):
    ...
    if json_data["annotations"]["object"][0]["class"] == 2:
        Y.append(0)
...
for file in os.listdir(label_path2):
    ...
    if json_data["annotations"]["object"][0]["class"] == 2:
        ...
        Y.append(1)
    # print(json_data["annotations"]["object"][0]["class"])
    if num == 1000:
        break
    num+=1
...
model.save_weights('main_insect.h5')
